 ...
 * @return	Always returns LPC_OK.
 */
ErrorCode_t vcom_read_req (eUSBInterfaces_s eUSBInterface, uint8_t *pBuf, uint32_t buf_len);
 ...
 */
uint32_t vcom_write (eUSBInterfaces_s eUSBInterface, uint8_t *pBuf, uint32_t buf_len);
