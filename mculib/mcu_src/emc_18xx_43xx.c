...
static void initDynMem(LPC_EMC_T *pEMC, IP_EMC_DYN_CONFIG_T *Dynamic_Config, uint32_t EMC_Clock)
{
	...
	for (ChipSelect = 0; ChipSelect < 4; ChipSelect++) {
		...
		if (DynAddr != 0) {
			...
			//temp = temp; //TODO: Thiago comentou
			(void)temp;
		}
	}
 ...
 */
static void initStaticMem(LPC_EMC_T *pEMC, IP_EMC_STATIC_CONFIG_T *Static_Config, uint32_t EMC_Clock)
{
