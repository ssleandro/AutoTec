...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_M2GPlus_es_unit_imperial[] = {
	17,
	ID(OutputString_11055), TYPEID_OUTSTR, WORD(72), WORD(16), COLOR_WHITE, ID(FontAttributes_23002), 1,
	...
	ID(OutputString_11089), TYPEID_OUTSTR, WORD(306), WORD(16), COLOR_WHITE, ID(FontAttributes_23004), 1,
		ID(ID_NULL), 0, WORD(16), 'S', 'e', 'm', 'i', 'l', 'l', 'a', 's', ' ', 'p', 'o', 'r', ' ', 'p', 'i', 'e', 0,
	ID(OutputString_11090), TYPEID_OUTSTR, WORD(171), WORD(12), COLOR_WHITE, ID(FontAttributes_23000), 1,
...
unsigned int ES_UNIT_METRIC_PKG_SIZE = sizeof(isoOP_M2GPlus_es_unit_metric);
unsigned int ES_UNIT_IMPERIAL_PKG_SIZE = sizeof(isoOP_M2GPlus_es_unit_imperial);